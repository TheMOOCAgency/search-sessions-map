...
function buildSearchBar(fields) {
    fields.map(function(field) {
        ...
        if (field.type === 'select') {
            var fieldInput = '<div class="col-lg-2 inputWrapper nineLeft"> <select class="custom-select mb-3" id="' + field.name + '"><option value="' + field.name + '">' + field.label + '</option>';
        ...
        sessionsByMonthList.map(function(sessionsInAMonth) {
            ...
            for (var i = 0; i < sessionsInAMonth.session.length; i++) {
                ...
                var courseReview =
                    ...
                    '<div class="col-lg-1  col-md-12 col-sm-12"><img src="media/microsite/inveest/search-sessions-map/icons/presentation.svg" alt="icône de personnage faisant une présentation sur un tableau" height="50px" width="50px"/></div>' +
